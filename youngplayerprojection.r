...
x.var <- subset(dp,select=c('Age','AgeSq','OBPM','DBPM','USG.','USGAST','TRBAST','TOV.','STL.','FT.','X3P.','FTr','X3PAr','MPG','G.','RelTS.','X3PA100adj','ORB.adj','DRB.adj','BLK100'))
...
x.var2 <- subset(dp2,select=c('Age','AgeSq','OBPM','DBPM','USG.','USGAST','TRBAST','TOV.','STL.','FT.','X3P.','FTr','X3PAr','MPG','G.','RelTS.','X3PA100adj','ORB.adj','DRB.adj','BLK100'))
x.var2 <- data.matrix(x.var2)
dp2$glmnet <- predict(glmnet.model, s=lamb, x.var2, type="response")


#Select variables for GBM
cols <- c('PeakBPM','Age','AgeSq','OBPM','DBPM','USG.','USGAST','TRBAST','TOV.','STL.','FT.','X3P.','FTr','X3PAr','MPG','G.','RelTS.','X3PA100adj','ORB.adj','DRB.adj','BLK100')
